...
len_of_binary_value = len(bin(2)[2:])


number_of_spaces = '%'+str(len_of_binary_value)+'s'\
...
for val in range(1,2+1):
    ...
    binary = number_of_spaces % bin_value
    binary = add_spaces_remove_zeros(binary, len_of_binary_value)
